<template>
  <container>
    <!-- <h1>分析报告</h1> -->
    <el-header style="height:50px; font-size: 22px" > 2020年3月云南省劳动力流向视图</el-header>
...
export default {
  ...
  methods: {
    empPopulationFlowData:(year_month)=>{
      ...
      window.fetch('http://127.0.0.1:5000/api/labor_flow_data?year_month=202003')
